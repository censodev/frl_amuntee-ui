...
@Component({
  selector: 'ngx-revenue-company',
  templateUrl: './revenue-company.component.html',
  styleUrls: ['./revenue-company.component.scss'],
})
export class RevenueCompanyComponent implements OnChanges, AfterViewInit, OnDestroy {
